...
class jyHEDModelV2_1_SGD_GradientTape(jyModelBase):
    def __init__(self):
        super(jyHEDModelV2_1_SGD_GradientTape, self).__init__()
            ...
            for stepsPerEpoch in range(iStepsPerEpochTrain):
                with tf.GradientTape() as tape:
                    ...
                    print(template.format(stepsPerEpoch + 1, iStepsPerEpochTrain, fAllLoss, listLoss[0],
                                          listLoss[1], listLoss[2], listLoss[3], listLoss[4], listLoss[5]))
                    # backprop
...
def generateClass():
    return jyHEDModelV2_1_SGD_GradientTape()
